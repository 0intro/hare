...
Tlb tlbstatic[] = {
	...
	{	TLBEPN(VIRTDRAM+16*MiB)|TLB16MB|TLBVALID,	/* RAM */
		TLBRPN(PHYSDRAM+16*MiB)|TLBERPN(PHYSDRAM+16*MiB),
		TLBWL1|TLBU2|TLBM|TLBXWR,
	},
	{	TLBEPN(VIRTDRAM+32*MiB)|TLB16MB|TLBVALID,	/* RAM */
		TLBRPN(PHYSDRAM+32*MiB)|TLBERPN(PHYSDRAM+32*MiB),
		TLBWL1|TLBU2|TLBM|TLBXWR,
	},
	{	TLBEPN(VIRTDRAM+48*MiB)|TLB16MB|TLBVALID,	/* RAM */
		TLBRPN(PHYSDRAM+48*MiB)|TLBERPN(PHYSDRAM+48*MiB),
		TLBWL1|TLBU2|TLBM|TLBXWR,
	},
	{	TLBEPN(VIRTDRAM+64*MiB)|TLB16MB|TLBVALID,	/* RAM */
		TLBRPN(PHYSDRAM+64*MiB)|TLBERPN(PHYSDRAM+64*MiB),
		TLBWL1|TLBU2|TLBM|TLBXWR,
	},
	{	TLBEPN(VIRTDRAM+80*MiB)|TLB16MB|TLBVALID,	/* RAM */
		TLBRPN(PHYSDRAM+80*MiB)|TLBERPN(PHYSDRAM+80*MiB),
		TLBWL1|TLBU2|TLBM|TLBXWR,
	},
	{	TLBEPN(VIRTDRAM+96*MiB)|TLB16MB|TLBVALID,	/* RAM */
		TLBRPN(PHYSDRAM+96*MiB)|TLBERPN(PHYSDRAM+96*MiB),
		TLBWL1|TLBU2|TLBM|TLBXWR,
	},
	{	TLBEPN(VIRTDRAM+112*MiB)|TLB16MB|TLBVALID,	/* RAM */
		TLBRPN(PHYSDRAM+112*MiB)|TLBERPN(PHYSDRAM+112*MiB),
		TLBWL1|TLBU2|TLBM|TLBXWR,
	},
...
confinit(void)
{
	...
	conf.nproc = 2000; /* its a supercomputer damnit */
	conf.nimage = 200;
	conf.nswap = 0;
	conf.nswppo = 0;
