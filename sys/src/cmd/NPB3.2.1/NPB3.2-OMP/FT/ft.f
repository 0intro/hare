...
c      common /bigarrays/ u0, pad1, u1, pad2, u2, pad3, indexmap
      double complex pad1(3), pad2(3)
      common /bigarrays/ u0, pad1, u1, pad2, indexmap
...
c---------------------------------------------------------------------
      ...
      call setup()
      call init_ui(u0, u1, indexmap, dims(1), dims(2), dims(3))
      call compute_indexmap(indexmap, dims(1), dims(2), dims(3))
...
c---------------------------------------------------------------------
      ...
      do iter = 1, niter
         ...
         call evolve(u0, u1, iter, indexmap, dims(1), dims(2), dims(3))
...
c---------------------------------------------------------------------
      ...
      subroutine init_ui(u0, u1, indexmap, d1, d2, d3)
...
c---------------------------------------------------------------------
      ...
      subroutine compute_indexmap(indexmap, d1, d2, d3)
