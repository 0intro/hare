...
c---------------------------------------------------------------------
      double precision 
     >   u       (5,  0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX),
     >   us      (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
     >   vs      (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
     >   ws      (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
     >   qs      (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
c     >   ainv    (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
     >   rho_i   (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
     >   speed   (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
     >   square  (0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX    ),
     >   rhs     (5,  0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX),
     >   forcing (5,  0:IMAX/2*2, 0:JMAX/2*2, 0:KMAX)
...
!$omp threadprivate(/work_1d/)
      ...
      double precision lhs(5,0:IMAX),lhsp(5,0:IMAX),lhsm(5,0:IMAX)
