 ...
 */
#define MPICH2_VERSION "1.0.7"
#define MPICH2_NUMVERSION 10007300
...
#define MPICH_ERR_LAST_CLASS 53     /* It is also helpful to know the  last valid class */
