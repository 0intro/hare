...
\begin{document}
\GTDProject[proj=hpd]{A Plan 9 reimplementation of the Hierarchical
  Patch Dynamics Modeling Platform}
...
note: deployment without input
\subsection*{Running Models}
note: deployment with input
\subsection*{Cleanup}
...
\Action[]{compare cost/benifit of using get/putenv}
\Action[]{set up regression tests}
