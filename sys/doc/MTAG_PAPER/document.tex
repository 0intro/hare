...
relocate the data.  This localization of the compuation leads to the better
...
executables as the mapper and/or the reducer.  It can be also viewed as way to
create pipeline multiple instances of mapper and multiple instances of reducer
where pipeline multiplexing and de-multiplexing is indirectly done by intput
...
This streaming is desinged around map-reduce mechanism, hence does not give a
