...
%
% Removed this first section as it seems to mistarget the conference
%
...
%grid, there is increasing interest in deploying new genre of applications 
%like dataflow applications and many-task applications. Typical commercial
%applications fall into the category of dataflow applications and involve
%executing lot of small and interdependent applications for small amount 
%of time.
%Unfortunately, most of the existing workload deployment solutions are 
%ill-suited
